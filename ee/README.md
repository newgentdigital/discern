...
# Discern Enterprise Edition ("EE")

The `ee/` directory contains proprietary, commercially licensed features and enhancements for Discern, developed by Newgent Digital and its contributors. These components are designed for advanced use cases and are not available under open-source licenses.
...
Discern Enterprise Edition provides cloud and enterprise-grade functionality tailored for Discern customers. It includes advanced features, integrations, and modules that require a valid commercial license from Newgent Digital when deployed on-premise.

## Comparison to other repository folders

- **Core folders (e.g., `src/`, `lib/`)**: These contain the open-source foundation of Discern, available under AGPLv3 or other open licenses.
